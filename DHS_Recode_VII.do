...
//global root "C:\Users\wb\WBG\Sven Neelsen - World Bank\MEASURE UHC DATA"
...
* Define the country names (in globals) in by Recode
	...
	do "${DO}/0_GLOBAL.do"
	*/
global DHScountries_Recode_VII "Jordan2017"  


* Define country name
local name "Jordan2017"
...
gen name = "`name'"
	...
	forval i=1/9 { //to facilitate reshape in the next step
	ren  hvidx_0`i'  hvidx_`i'
	ren  hc70_0`i'   hc70_`i'
	ren  hc71_0`i'   hc71_`i'
	ren  hv104_0`i'  hv104_`i'
	ren  hv105_0`i'  hv105_`i'
	ren  hv101_0`i'  hv101_`i'
	ren  hc1_0`i'    hc1_`i'
	ren  hc32_0`i'   hc32_`i'
	}

** Reshape 
reshape long  hv104_  hv105_  hv101_   hvidx_ hc1_ hc32_ hc70_ hc71_ , i(hhid) j(abc)
...
use `hm',clear
merge m:m hv001 hv002 hvidx using `hiv'
drop _merge
save `hm',replace
...
use "${SOURCE}/DHS-`name'/DHS-`name'hm.dta", clear
	forval i=1/9 { //to facilitate reshape in the next step
	ren  hvidx_0`i'  hvidx_`i'
	ren  hv106_0`i'  hv106_`i'
	ren  hv101_0`i'  hv101_`i'
	}

	reshape long  hvidx_ hv106_ hv101_ hv270_ hv271_ , i(hhid) j(abc)
	
    rename (hv001 hv002 hvidx_) (v001 v002 v003)

    merge m:m v001 v002 v003 using "${SOURCE}/DHS-`name'/DHS-`name'birth.dta"
    rename (v001 v002 v003) (hv001 hv002 hvidx_) 
    drop _merge
...
use `hm',clear
rename hvidx_ hvidx
    merge m:m hv001 hv002 hvidx  using `birth',update              //missing update is zero, non missing conflict for all matched.(hvidx different) 
