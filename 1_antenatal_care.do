...
******************************   
	...
	*c_anc_ear: First antenatal care visit in first trimester of pregnancy of births in last 2 years
	...
	replace c_anc_ear = 0 if m2n !=.   // m13 based on Women who had seen someone for antenatal 
	replace c_anc_ear = 1 if inrange(m13,0,3) //care for their last born child
	...
	*c_anc_ir: iron supplements taken during pregnancy of births in last 2 years
	...
	gen c_anc_ir = inlist(anc_ir,1,2) if  !mi(anc_ir)
